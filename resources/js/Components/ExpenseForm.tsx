        ...
        <div className='p-10 flex justify-center'>
            <form className='flex flex-col space-y-3 w-full' onSubmit={submit}>
                ...
                <button disabled={processing} type="submit" 
                    className={`${processing ? 'opacity-50 cursor-not-allowed' : 'hover:bg-purple-800 cursor-pointer'} mt-5 w-full p-3 rounded-lg text-white font-bold  text-xl disabled:opacity-50`}>
