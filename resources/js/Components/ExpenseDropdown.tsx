...
export default function ExpenseDropdown({ expense }: Props) {
    ...
    return (
        <Menu as="div" className="relative inline-block ">
            <MenuButton className="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs inset-ring-1 inset-ring-gray-300 hover:bg-gray-50 dark:bg-gray-800 dark:text-white dark:shadow-none dark:inset-ring-gray-700 dark:hover:bg-gray-700">
                Opciones
            </MenuButton>
                ...
                <div className="py-1">
                    <MenuItem>
                        <button
                            ...
                            className="group flex w-full items-center px-4 py-2 text-left text-sm text-gray-700 data-focus:bg-gray-100 data-focus:text-gray-900 data-focus:outline-hidden dark:text-gray-300 dark:data-focus:bg-white/5 dark:data-focus:text-white"
                        >
                            Editar
                        </button>
                    </MenuItem>
