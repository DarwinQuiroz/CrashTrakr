        ...
        <>
            ...
            <section className="p-10 lg:px-5 shadow-lg mt-10">
                <div className="flex items-center justify-between">
                    ...
                    <button
                        className="bg-purple-600 hover:bg-purple-800 px-5 py-2 rounded-lg text-white font-bold text-xl cursor-pointer"
                                ...
                                <table className="relative min-w-full">
                                    ...
                                    <tbody className="divide-y divide-gray-300 ">
                                        {budget.expenses.map((expense) => (
                                            ...
                                            >
                                                <td
                                                    className={`${budget.type == "general" ? "pt-15" : "pt-5"} pb-5 px-10 relative`}
                                                >
                                                    {budget.type ==
                                                        "general" && (
                                                        <p
