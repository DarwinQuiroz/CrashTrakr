    ...
    return (
        ...
        <section className="sm:flex sm:items-center mt-10">
            ...
            <div className="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                <a href={'/dashboard'} className="block bg-amber-500 text-white w-full px-5 py-3 rounded-lg  font-bold  text-xl cursor-pointer text-center">
        ...
        <section className='p-10 lg:px-5 shadow-lg mt-10'>
            <div className='flex items-center justify-between'>
                ...
                <button className='bg-purple-600 hover:bg-purple-800 px-5 py-2 rounded-lg text-white font-bold text-xl cursor-pointer' onClick={openCreateModal}>
                    Nuevo Gasto
                </button>
            </div>
        </section>
