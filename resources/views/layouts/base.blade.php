        ...
        <header class="bg-purple-950 py-5">
            <div class="max-w-6xl mx-auto flex flex-col lg:flex-row items-center lg:justify-between">
                <div class="w-full max-w-100">
                    <img src="{{ asset('img/logo.svg') }}" alt="Logo Crashtrakr" class="w-full block">
                </div>
                ...
                <nav class="flex flex-col lg:flex-row items-center gap-4">
                    ...
                    @else
                        ...
                        @if(Route::has('register'))
                            <a href="{{ route('register') }}" class="font-bold uppercase border-2 border-amber-500  px-5 py-2 text-amber-500">
                                Crear Cuenta
                            </a>
                        @endif
                    @endif
